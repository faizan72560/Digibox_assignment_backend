...
const{post,updatepost,deletepost,getpost, getallpost, getsinglepost, request}=require('../controller/postController')
...
router.route('/addrequest').post(isAuthenticatedusers,request)
